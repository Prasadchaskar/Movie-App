const apiKey = '07ceb0abc5837d6c8d03f3f615810380';
...
const movie = fetchAndShowResult(`https://api.themoviedb.org/3/search/movie?api_key=${apiKey}&query=batman`);
// console.log(movie);
...
//Clear result element for the search
...
//Detect end of the page and load more results
function detectEnd() {
